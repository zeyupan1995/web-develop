...
//   04. Remove Default Templates
//   05. Remove Meta Boxes
//   06. Disable Frontend Editor
//   07. Map Shortcodes
//   08. Update Existing Shortcodes
//   09. Incremental ID Counter for Templates
//   10. Overwrite No Content Message
//   11. Overwrite Layout Error Message
// =============================================================================
...
if ( ! function_exists( 'x_visual_composer_remove_default_templates' ) ) {

  function x_visual_composer_remove_default_templates( $data ) {
    return array();
  }

  add_filter( 'vc_load_default_templates', 'x_visual_composer_remove_default_templates' );
