...
( function( $ ) {
  ...
  wp.customize( 'x_layout_site_max_width', function( value ) {
    value.bind( function( newval ) {
      $( 'body .x-container-fluid.max' ).css( 'max-width', newval + 'px' );
  ...
  wp.customize( 'x_layout_site_width', function( value ) {
    value.bind( function( newval ) {
      $( 'body .x-container-fluid.width' ).css( 'width', newval + '%' );
  ...
  wp.customize( 'x_layout_content_width', function( value ) {
    value.bind( function( newval ) {
      ...
      if ( $( 'body' ).hasClass( 'x-integrity' ) ) {
        ...
        $( 'body' ).prepend('<style scoped>body.x-content-sidebar-active:not([class*="template-blank"]) .x-container-fluid.main:before { right: ' + ( 100 - newval ) + '%; } body.x-sidebar-content-active:not([class*="template-blank"]) .x-container-fluid.main:before { left: ' + ( 100 - newval ) + '%; }</style>');
